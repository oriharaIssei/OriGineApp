...
public: // accsessor
    ...
    int32_t GetRow() const { return rowNum_; }
    int32_t GetColumn() const { return columnNum_; }
    ...
    void SetRow(const int32_t& colum) {rowNum_ = colum;}
    void SetColumn(const int32_t& row) { columnNum_ = row; }
